...
def show_result(model, img, result, out_file=None, show=False, win_name=""):
    ...
    Args:
        ...
        show(bool): wether show img
        win_name(str): window name
    """
    if hasattr(model, 'module'):
        model = model.module

    model.show_result(model, img, result, out_file=out_file, show=show, win_name=win_name)
