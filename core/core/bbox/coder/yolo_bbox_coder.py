...
class YOLOBBoxCoder(BaseBBoxCoder):
    ...
    def encode(self, bboxes, gt_bboxes, stride):
        ...
        Args:
            bboxes (torch.Tensor): Source boxes, e.g., pos anchors.
        ...
        # anchor和gt都是原图坐标值,故需要/stride,变成特征图尺度
    ...
    def decode(self, bboxes, pred_bboxes, stride):
        ...
        Args:
            bboxes (torch.Tensor): Basic boxes, e.g. anchors.
        ...
        x_center = (bboxes[..., 0] + bboxes[..., 2]) * 0.5  # 这个x_center应该是原图尺度
        y_center = (bboxes[..., 1] + bboxes[..., 3]) * 0.5
        w = bboxes[..., 2] - bboxes[..., 0]
        h = bboxes[..., 3] - bboxes[..., 1]
        # Get outputs x, y
