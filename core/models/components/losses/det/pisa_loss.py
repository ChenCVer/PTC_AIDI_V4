import torch
from core.core import bbox_overlaps
...
def isr_p(cls_score,
    ...
    # For single stage objectdetection, rois here indicate anchors, in shape (N, 4)
    # For two stage objectdetection, rois are in shape (N, 5)
    if rois.size(-1) == 5:
