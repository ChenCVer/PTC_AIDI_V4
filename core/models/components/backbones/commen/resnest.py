...
class Bottleneck(_Bottleneck):
    ...
    Args:
        ...
        width_per_group (int): Base of width in terms of base channels. Default: 4.
    ...
    def __init__(self,
        ...
        if groups == 1:
            ...
            width = math.floor(self.planes *
                               (width_per_group / base_channels)) * groups
...
class ResNeSt(ResNetV1d):
    ...
    Args:
        ...
        base_width (int): Width per group of conv2 in Bottleneck.Default: 4
        radix (int): Radix of SpltAtConv2d. Default: 2
    ...
    def __init__(self,
        ...
        self.radix = radix
        # reduction_factor: Reduction factor of SplitAttentionConv2d.
