...
data_root = "/home/cxj/Desktop/data/electronic_datasets/0203数据标注/img"
save_root = "/home/cxj/Desktop/data/electronic_datasets/0203数据标注/mask"
...
for idx, img_name in enumerate(img_names):
    ...
    with open(json_path, 'r', encoding='utf8')as fp:
        ...
        for jdx, label in enumerate(labels):
            points = label["points"]
            cv2.circle(mask, (int(points[0][1]), int(points[0][0])), 1, 255)
    ...
    for kdx, point in enumerate(points):
        ...
        draw_umich_gaussian(heatmap, center, 10)
